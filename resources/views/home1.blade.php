          ...
          @foreach($posts as $post)
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> <img class="img-responsive" src="{{ $post->image }}" alt=""> </div>
          ...
          @foreach($posts as $po)
            <div class="col-md-4">
                <div class="full blog_colum">
                    <div class="blog_feature_img"> <img src="{{ $po->image }}" alt="#" /> </div>
                    <div class="post_time">
                        <p><i class="fa fa-clock-o"></i>  {{ $po->created_at }}</p>
                    </div>
                    <div class="blog_feature_head">
                        <h4>{{ $po->title }}</h4>
                    </div>
                    <div class="blog_feature_cont">
                        <p> {{ $po->meta_description }}</p>
                    </div>
                </div>
            </div>
        @endforeach
